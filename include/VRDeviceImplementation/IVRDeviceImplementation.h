...
#define I_VRDEVICE_API_VERSION 2
...
#include <QtGui/QMatrix4x4> //TODO: forward declare this so I don't need the header
...
#define VRDEVICE_INTERFACE_IID "org.evilpicturebook.vrdevice_iid"
Q_DECLARE_INTERFACE(VR::Plugin::IVRDeviceImplementation, VRDEVICE_INTERFACE_IID)
